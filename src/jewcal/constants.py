...
YOMTOV: dict[int, dict[int, Event]] = {
    ...
    7: {
        ...
        17: Event('Chol HaMoed 1 (Sukkos 3)', Category.HAVDALAH.value),
        18: Event('Chol HaMoed 2 (Sukkos 4)', Category.HAVDALAH.value),
        19: Event('Chol HaMoed 3 (Sukkos 5)', Category.HAVDALAH.value),
        20: Event('Chol HaMoed 4 (Sukkos 6)', Category.HAVDALAH.value),
